...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (438409,40480225,45765570)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (438409,40480225,45765570)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (705944,704053,709567,731533,719311,742185,714785,19026274,4273557,46257633,36683664,4101536,46257742)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (705944,704053,709567,731533,719311,742185,714785,19026274,4273557,46257633,36683664,4101536,46257742)
  and c.invalid_reason is null
...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2015, 12, 31) and C.drug_exposure_start_date <= DATEFROMPARTS(2019, 12, 31))
...
WHERE (C.measurement_date >= DATEFROMPARTS(2015, 12, 31) and C.measurement_date <= DATEFROMPARTS(2019, 12, 31))
